...
import App from '../App';
import { dataMeals } from './Mocks/localStorageMock';

const DONE_RECIPES = '/done-recipes';
const IMG_LINK = '0-horizontal-image';

describe('Testa o componente Done Recipes Com Meals', () => {
  beforeEach(() => localStorage.setItem('doneRecipes', JSON.stringify(dataMeals)));
